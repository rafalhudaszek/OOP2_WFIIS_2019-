//ProszÄ zaimplementowaÄ klasÄ lab3string
//UWAGA! RozwiÄzanie w stylu:
//String wspak(String a)
// {
//  return "kapsw eizdeb ot";
// }
// oznacza automatycznie 0 (ZERO) punktĂłw (choÄby dotyczyĹo TYLKO JEDNEJ metody).
...
public class lab3
{
 public static void main(String[] args)
 {
  ...
  //palindrom to sĹowo ktĂłre czytane wspak jest takie samo
  ...
  //sĹowo - nazwijmy je "abecadĹowe" to takie w ktĂłrym litery wystÄpujÄ w kolejnoĹci alfabetycznej
  //np "abc" czy "aceh" to sĹowa abecadĹowe a "zda" juĹź takim sĹowem nie jest
  ...
  //2 punkty
  // ROT13 to metoda kodowania polegajÄca na tym, ze przesuwamy litery o 13 do przodu w alfabecie czyli:
